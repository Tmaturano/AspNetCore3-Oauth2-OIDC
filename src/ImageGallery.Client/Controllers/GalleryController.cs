...
{ 
    ...
    public class GalleryController : Controller
    {
        ...
        {
            await WriteOutIdentityInformationAsync();
        ...
        public async Task Logout()
        {
            ...
            // Revoke the tokens since we are not going to use them anymore when logging out
        ...
        public async Task WriteOutIdentityInformationAsync()
        {
            // get the saed identity token
